...
Substituir o esqueleto de debug da página `/produtos/[slug]` por uma implementação completa e fiel ao Figma (nodes `1071:11152` desktop / `1071:10877` mobile).
...
- Info produto desktop: node `1071:11161`, `padding: 24px 170px`, `bg-[#F8F8F8]`, layout row com specs à direita
- Imagem produto mobile: dentro de `1071:10877` (mobile frame)
...
- Rodar `/poc-refine-design` nos nodes `1071:11152` (desktop) e `1071:10877` (mobile) antes da implementação
