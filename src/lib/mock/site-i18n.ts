...
const SITE_SOCIAL_SECTION_EN: SocialFeedSection = {
  ...SITE_SOCIAL_SECTION,
  title: 'OUR FAMILY',
  subtitle: 'Join the community of sound professionals. See our latest projects, events and sneak peeks.',
...
const MILESTONE_PATTERN_EN = ['POWER', 'QUALITY', 'INNOVATION', 'MADE IN BRAZIL', 'SINCE 1989']
...
const HOME_FAQ_SECTION_ES: SiteHomePayload['faqSection'] = {
  label: 'Preguntas',
  title: 'PREGUNTAS\nFRECUENTES',
  subtitle: '¿No encontró lo que busca? Póngase en contacto con nuestro soporte.',
...
const SITE_SOCIAL_SECTION_ES: SocialFeedSection = {
  ...
  subtitle: 'Únase a la comunidad de profesionales del sonido. Vea nuestros últimos proyectos, eventos y adelantos.',
...
const MILESTONE_PATTERN_ES = ['POTENCIA', 'CALIDAD', 'INNOVACIÓN', 'HECHO EN BRASIL', 'DESDE 1989']

// ─── Locale selectors ─────────────────────────────────────────────────────────

type LocaleContentMap<T> = { 'pt-BR': T; en: T; es: T }

function selectLocale<T>(map: LocaleContentMap<T>, locale: string | undefined): T {
...
export function getHomeHeroSlides(locale?: string): HeroBannerSlide[] {
  return selectLocale(
    { 'pt-BR': HOME_HERO_SLIDES, en: HOME_HERO_SLIDES_EN, es: HOME_HERO_SLIDES_ES },
    locale,
  )
}
...
export function getHomeFeaturedSection(locale?: string): SiteHomePayload['featured'] {
  return selectLocale(
    { 'pt-BR': HOME_FEATURED_SECTION, en: HOME_FEATURED_SECTION_EN, es: HOME_FEATURED_SECTION_ES },
    locale,
  )
}

export function getHomeHistorySection(locale?: string): SiteHomePayload['history'] {
  return selectLocale(
    { 'pt-BR': HOME_HISTORY_SECTION, en: HOME_HISTORY_SECTION_EN, es: HOME_HISTORY_SECTION_ES },
    locale,
  )
}
...
export function getHomeFaqSection(locale?: string): SiteHomePayload['faqSection'] {
  return selectLocale(
    { 'pt-BR': HOME_FAQ_SECTION, en: HOME_FAQ_SECTION_EN, es: HOME_FAQ_SECTION_ES },
    locale,
  )
}
...
export function getSocialSection(locale?: string): SocialFeedSection {
  return selectLocale(
    { 'pt-BR': SITE_SOCIAL_SECTION, en: SITE_SOCIAL_SECTION_EN, es: SITE_SOCIAL_SECTION_ES },
    locale,
  )
}
...
export function getAboutHeroSection(locale?: string): SiteAboutPayload['hero'] {
  return selectLocale(
    { 'pt-BR': ABOUT_HERO_SECTION, en: ABOUT_HERO_SECTION_EN, es: ABOUT_HERO_SECTION_ES },
    locale,
  )
}

export function getAboutQualitySection(locale?: string): SiteAboutPayload['quality'] {
  return selectLocale(
    { 'pt-BR': ABOUT_QUALITY_SECTION, en: ABOUT_QUALITY_SECTION_EN, es: ABOUT_QUALITY_SECTION_ES },
    locale,
  )
}
...
export function getAboutJobsCta(locale?: string): SiteAboutPayload['jobsCta'] {
  return selectLocale(
    { 'pt-BR': ABOUT_JOBS_CTA_SECTION, en: ABOUT_JOBS_CTA_EN, es: ABOUT_JOBS_CTA_ES },
    locale,
  )
}
...
export function getMilestonePattern(locale?: string): string[] {
  return selectLocale(
    { 'pt-BR': MILESTONE_PATTERN, en: MILESTONE_PATTERN_EN, es: MILESTONE_PATTERN_ES },
    locale,
  )
}
...
export function getCompanyStats(locale?: string): CompanyStat[] {
  return selectLocale(
    { 'pt-BR': COMPANY_STATS, en: COMPANY_STATS_EN_ABOUT, es: COMPANY_STATS_ES },
    locale,
  )
}
