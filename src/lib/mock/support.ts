  ...
  cards: [
    {
      ...
      description: 'Acesse manuais técnicos, catálogos, fotos de produto, logos e wallpapers oficiais da Stetsom.',
      cta: 'Acessar',
    },
    {
      id: 'postos-autorizados',
      title: 'Postos Autorizados',
      description: 'Encontre a assistência técnica autorizada mais próxima de você por CEP ou cidade.',
      cta: 'Localizar',
    },
    {
      id: 'fale-conosco',
      title: 'Fale Conosco',
      description: 'Entre em contato com nossa equipe de suporte técnico para esclarecer dúvidas e resolver problemas.',
      cta: 'Contato',
    },
  ],
