...
export const SITE_SOCIAL_SECTION: SocialFeedSection = {
  ...
  posts: [
    {
      id: 'social-1',
      caption: 'Instalacao premium com a linha Stetsom Digital Bass.',
      media_type: 'IMAGE',
      media_url: FIGMA_SITE_ASSETS.socialOne,
      permalink: 'https://www.instagram.com/p/stetsom-001/',
      timestamp: '2026-05-01T18:30:00Z',
      username: 'stetsombrasil',
      opacity: 0.82,
    },
    {
      id: 'social-2',
      caption: 'Projeto finalizado com potencia e acabamento impecavel.',
      media_type: 'IMAGE',
      media_url: FIGMA_SITE_ASSETS.socialTwo,
      permalink: 'https://www.instagram.com/p/stetsom-002/',
    ...
    {
      id: 'social-3',
      caption: 'Setup de grave extremo para competicao de som automotivo.',
      media_type: 'IMAGE',
      media_url: FIGMA_SITE_ASSETS.socialThree,
      permalink: 'https://www.instagram.com/p/stetsom-003/',
    ...
    {
      id: 'social-4',
      caption: 'Highlights do evento com a comunidade Stetsom.',
      media_type: 'IMAGE',
      media_url: FIGMA_SITE_ASSETS.socialFour,
      permalink: 'https://www.instagram.com/p/stetsom-004/',
    ...
    {
      id: 'social-5',
      caption: 'Spoiler da nova linha com design agressivo.',
      media_type: 'IMAGE',
      media_url: FIGMA_SITE_ASSETS.socialFive,
      permalink: 'https://www.instagram.com/p/stetsom-005/',
