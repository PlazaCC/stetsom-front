...
const SUPPORT_HERO_EN: SupportPayload['hero'] = {
  ...
  label: 'Help Center',
  title: 'HOW CAN WE\nHELP YOU',
  description: 'Our technical team is ready to help you get the most out of your Stetsom products.',
}
...
const SUPPORT_CARDS_EN: SupportCard[] = [
  {
    ...
    description: 'Access technical manuals, catalogs, product photos, logos and official Stetsom wallpapers.',
    cta: 'Access',
  },
  {
    id: 'postos-autorizados',
    title: 'Authorized Centers',
    description: 'Find the nearest authorized service center by ZIP code or city.',
    cta: 'Locate',
  },
  {
    id: 'fale-conosco',
    title: 'Contact Us',
    description: 'Get in touch with our technical support team to clarify questions and resolve issues.',
    cta: 'Contact',
  },
]
...
const SUPPORT_HERO_ES: SupportPayload['hero'] = {
  ...
  title: 'CÓMO PODEMOS\nAYUDARTE',
  description: 'Nuestro equipo técnico está listo para ayudarte a sacar el máximo partido de tus productos Stetsom.',
}
...
const SUPPORT_CARDS_ES: SupportCard[] = [
  {
    ...
    description: 'Accede a manuales técnicos, catálogos, fotos de productos, logos y wallpapers oficiales de Stetsom.',
    cta: 'Acceder',
  },
  {
    id: 'postos-autorizados',
    title: 'Centros Autorizados',
    description: 'Encuentra el centro de servicio técnico autorizado más cercano por código postal o ciudad.',
    cta: 'Localizar',
  },
  {
    id: 'fale-conosco',
    title: 'Contáctanos',
    description: 'Ponte en contacto con nuestro equipo de soporte técnico para aclarar dudas y resolver problemas.',
    cta: 'Contacto',
  },
]
...
const SUPPORT_CONTACT_ES: SupportPayload['contact'] = {
  label: 'Contacto',
  title: 'Contáctanos',
  description: 'Complete el formulario a continuación y nuestro equipo responderá en breve.',
}
