...
export default async function SuportePage() {
  ...
  return (
    <div>
      ...
      <SupportContact contact={supportPayload.contact} contactInfo={supportPayload.contactInfo} />
      <SupportServiceCenters serviceCenters={serviceCenters} mapImage={supportPayload.mapImage} />
      <SupportDocumentation categories={categories} files={supportPayload.documentationFiles} />
