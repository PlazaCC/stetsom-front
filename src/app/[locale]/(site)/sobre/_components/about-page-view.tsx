  ...
  return (
    <div>
      ...
      {!qualityData.hidden && qualityData.image_url && (
        <EditableSection target="section:quality" editable={editable}>
          <QualitySection
            section={{
      ...
      {!timelineData.hidden && timelineData.events?.length ? (
        <EditableSection target="section:timeline" editable={editable}>
          <TimelineCarousel
      ...
      {!valuesData.hidden && valuesData.bases?.length ? (
        <EditableSection target="section:values" editable={editable}>
      ...
      {!factoryData.hidden && (
        <EditableSection target="section:jobs-cta" editable={editable}>
          <OurFactory
            jobsCta={{
