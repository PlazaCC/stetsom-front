  ...
  return (
    <aside className='hidden lg:flex flex-col gap-5 w-90 shrink-0'>
      <div className='flex items-center justify-between'>
        <h2 className='font-sans font-bold text-lg text-foreground'>{t('filters')}</h2>
      ...
      <div className='border-t border-border pt-5'>
        <div className='flex items-center justify-between'>
          <span className='font-sans font-bold text-lg text-foreground'>{t('options')}</span>
      ...
      <div className='border-t border-border pt-5'>
        <div className='flex items-center justify-between'>
          <span className='font-sans font-bold text-lg text-foreground'>{t('search')}</span>
        </div>
      ...
      <div className='border-t border-border pt-5'>
        <div className='flex items-center justify-between'>
          <span className='font-sans font-bold text-lg text-foreground'>{t('productType')}</span>
          <ChevronDown size={16} className='text-muted-foreground' />
        </div>
      ...
      <div className='border-t border-border pt-5'>
        <div className='flex items-center justify-between'>
          <span className='font-sans font-bold text-lg text-foreground'>{t('productLines')}</span>
          <ChevronDown size={16} className='text-muted-foreground' />
        </div>
