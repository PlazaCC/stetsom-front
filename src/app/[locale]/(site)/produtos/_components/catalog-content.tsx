...
function toCategoryOptions(categories: Category[], allLabel: string): CategoryOption[] {
  return [
...
export function CatalogContent() {
  ...
  const categoryOptions = useMemo(() => toCategoryOptions(categories, t('allCategories')), [categories, t])
        ...
        <Container>
          <div className='flex gap-9'>
            ...
            <div className='flex-1 min-w-0'>
              ...
              {isLoading ? (
                <div className='text-center py-16 text-muted-foreground text-base'>{t('loading')}</div>
                ...
                <div className='text-center py-16 text-muted-foreground text-base'>{t('noProducts')}</div>
              )}
            </div>
          </div>
        </Container>
