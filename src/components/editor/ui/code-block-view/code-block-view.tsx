    ...
    <>
      ...
      >
        <select
          ...
          className="outline-unset focus:outline-unset relative box-border w-auto cursor-pointer appearance-none rounded-sm border-none bg-transparent px-2 py-1 text-xs text-(--prosemirror-highlight) opacity-0 transition select-none hover:opacity-80 [div[data-node-view-root]:hover_&]:opacity-50 hover:[div[data-node-view-root]:hover_&]:opacity-80"
