  ...
  return (
    <div ref={ref} className='relative'>
      <button
        ...
        <span className='font-sans font-semibold uppercase tracking-wide'>{LOCALE_CODES[locale]}</span>
        <ChevronDown
          size={12}
      ...
      {open && (
        <div
          className={cn(
            ...
            isLight ? 'bg-white border-border' : 'bg-brand-dark border-white/10',
          )}>
          {routing.locales.map((loc) => (
            <button
              ...
              <span className='font-sans font-semibold uppercase tracking-wide'>{LOCALE_CODES[loc as Locale]}</span>
