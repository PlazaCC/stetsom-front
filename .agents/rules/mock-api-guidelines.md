...
- Do not hardcode schema differences in the frontend; change the contract file `src/lib/api/contracts.ts` first, then update mocks and append a changelog entry to `docs/ia/context.json`.
